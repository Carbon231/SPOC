    ...
    <el-container>
      ...
      <el-container class="main">
        ...
        <el-main style="padding-left: 10%; padding-right: 10%">
          ...
          <h2>介绍</h2>
          <p>Spooc课程平台是一个创新的在线教育解决方案，旨在为学生和教师提供一个全面、互动和用户友好的选课、教学和学习环境。</p>

          <h4>(1)综合需求</h4>
          <p>Spooc课程平台通过整合以下核心功能，满足教育过程中的多样化需求：</p>
          <ul>
          ...
          <h4>讨论区</h4>
          <p>讨论区是Spooc课程平台的社交中心，学生和教师可以在这里交流思想，分享知识，提问和解答。请积极参与讨论，同时关注平台的通知和更新。如果您有任何问题或建议，欢迎向Spooc工作组反馈，我们将竭诚为您服务。</p>

        </el-main>
      </el-container>
    </el-container>
    <el-dialog title="Cookies通知" :visible.sync="dialogVisible" :modal="true" class="cookie-consent-dialog">
      <div class="content">
